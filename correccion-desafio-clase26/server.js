/************* sin uso *********/
/************* todo lo que no se utiliza se recomienda borrarlo *********/

//import ProductContenedor from "./src/contenedores/ProductContenedor.js"; // no se esta usando
//const productContenedor = new ProductContenedor();
// import exphbs from "express-handlebars" // handlebars no se usa
// import productRouter from "./src/routers/products.js" // ambos router no se estan usando
// import messagesRouter from "./src/routers/messages.js" // ambos router no se estan usando
// import MongoStore from "connect-mongo"; // no se esta usando

//const usuarioDAO = mongoose.model("usuarios", usuarioSchema); // sin uso

//const mensajeDAO = mongoose.model("mensaje", mensajeSchema); // sin uso

// await mensajeDAO.create({
//   author: {
//     id: 2,
//     nombre: "federico",
//     apellido: "gonzalez",
...
// app.get("/products", (req, res) => { // endoint sin uso... 
...
//import { log } from "console"; // sin uso
/************* sin uso *********/
...
// la forma de realizar el siguiente import no era la correcta y por ende passport-local no iba a funcionar:
//import LocalStrategy from "passport-local"; 
// >> correccion >> hay varias formas, una es usando las siguientes 2 lineas:
...
// la definicion del esquema tiene los siguientes errores:
// >> los nombres de los atributos no coinciden con los traidos del front (id, name, surname, age, alias, avatar, date)
// al no coincidir no se guardan coerrectamente en la base de datos mongo 
...
const CANT_PERS_DEFAULT = 5; // a corregir: para qeu sea mas descriptivo deberia llamarse CANT_PROD_DEFAULT en vez de CANT_PERS_DEFAULT

app.get("/api/productos-test", (req, res) => {
  const cant = Number(req.query.cant) || CANT_PERS_DEFAULT; // significa que si no recibe el parametro la cantidad por default sera 5. Number() convierte el parametro a tipo number (los parametros se reciben como tipo string)
